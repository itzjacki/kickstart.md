...
- **Ask about the product.** Never assume you understand the application, its users, or its domain. The code tells you _how_ — the user tells you _what_ and _why_.
